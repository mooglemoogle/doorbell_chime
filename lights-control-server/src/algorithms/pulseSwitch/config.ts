...
export const config: AlgorithmConfig = {
  ...
  options: {
    ...
    properties: {
      ...
      lightsPerColor: { title: 'Number of lights per color', type: 'integer', default: 1, minimum: 1 },
      spaceBetween: { title: 'Number of blank spaces between colors', type: 'integer', default: 0, minimum: 0 },
    },
    default: {
      colors: [[0.333, 0.929, 0.663], [0, 0.937, 0.808]],
      onTime: 5,
      pulseTime: 0.5,
      lightsPerColor: 1,
      spaceBetween: 0,
